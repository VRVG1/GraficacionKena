...
import java.awt.*;
public class PolilinaJava extends JFrame{
    public PolilinaJava () {
    ...
    public void octagono(Graphics g) {
        ...
        dibujar_Poligono(x, y, Color.BLACK, 1, g);
    ...
    public void wave(Graphics g) {
        ...
        dibujar_Polilinia(x, y, Color.BLACK, 1, g);
    ...
    public void putrid_face(Graphics g) {
        ...
        int[] x1 = {45,55,65};
        int[] y1 = {175,155,175};
        dibujar_Polilinia(x1, y1, Color.black, 1, g);
        g.drawPolyline(x1, y1, x1.length);
        int[] x2 = {75,85,95};
        int[] y2 = {175,155,175};
        dibujar_Polilinia(x2, y2, Color.black, 1, g);
        g.drawPolyline(x2, y2, x1.length);
        int[] x3 = {60,70,80};
        int[] y3 = {180,190,180};
        dibujar_Polilinia(x3, y3, Color.black, 1, g);
        g.drawPolyline(x3, y3, x1.length);
        int[] x4 = {60,70,80};
        int[] y4 = {205,195,205};
        dibujar_Polilinia(x4, y4, Color.black, 1, g);
        g.drawPolyline(x4, y4, x1.length);
    }
